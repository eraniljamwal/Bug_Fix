...
// @codekit-prepend: '../bower_components/jquery_lazyload/jquery.lazyload.js'
// @codekit-prepend: '../bower_components/fitvids/jquery.fitvids.js'
// @codekit-prepend: '../bower_components/aos/dist/aos.js'
// @codekit-prepend: '../bower_components/lightcase/src/js/lightcase.js'
...
// ** Lasy load images with the "lazy" class **
$(function() {
  $(".lazy").lazyload({
    effect : "fadeIn"
  });
...
$(window).scroll(function(){
  ...
  if (lastId !== id) {
    menuItems.parent().removeClass("active").end()
    .filter("[href='#"+id+"']").parent().addClass("active");

    $('.scroll-sections section').removeClass("active");
    $('.scroll-sections').find('#'+id).addClass("active");
  }
});
